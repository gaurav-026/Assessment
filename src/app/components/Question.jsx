...
// function Question() {
//   return (
//     <div className=' lg:md:w-[730px]  w-[328px] lg:md:h-[715px] h-[815px] absolute lg:md:top-[2394px] top-[2150px] lg:md:left-[355px] left-[29px]  lg:md:-z-20 '>
...
//         </div>
//         <div className='  lg:md:w-[730px] w-[328px]  lg:md:h-[563px] h-[815px] mt-[60px] gap-[16px] flex flex-col'>
//            <div className='lg:md:w-[730px] w-[328px] lg:md:h-[48px] h-[62px] rounded-[16px] pt-[14px] pr-[20px] pb-[14px] pl-[20px] gap-[20px] bg-[#D6D6D6] flex'>
...
//            <div className='lg:md:w-[730px] lg:md:h-[115px] w-[327] h-[184px] rounded-[16px] pt-[14px] pr-[20px] pb-[14px] pl-[20px] gap-[14px] bg-[#D6D6D6] flex flex-col'>
//               <div className='lg:md:w-[690px] w-[295px] lg:md:h-[20px] h-[34px] gap-[20px] flex'>
...
//               </div>
//               <div className=' lg:md:w-[690px] w-[295px] h-[1px]  bg-[#11151D] opacity-[8%]'></div>
//               <div className='lg:md:w-[690px] w-[295]  lg:md:h-[38px] h-[85px] font-[Urbanist]   font-[500] leading-[19.2px]  text-black'>No, not at all! Our platform is designed with user-friendliness in mind. You can easily navigate and set up your store without any technical expertise. It&apos;s as simple as a few clicks to get started!</div>
//            </div>
//            <div className='lg:md:w-[730px] w-[328px] lg:md:h-[48px] h-[62px] rounded-[16px] pt-[14px] pr-[20px] pb-[14px] pl-[20px] gap-[20px] bg-[#D6D6D6] flex'>
