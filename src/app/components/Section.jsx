...
//         <div className='lg:md:w-[1264px] w-[370px]  lg:md:h-[644px] h-[571px]  gap-[50px] flex flex-col  lg:md:mx-auto lg:md:ml-0 ml-[-41px]  '>
//             <div className='lg:md:w-[1264px] w-[360px] h-[540px]  flex flex-col gap-[70px] '>
...
//             <div className='hidden lg:md:inline'> <ImageSlider images={images} interval={1500} alt="Payment Sample" width={720} height={405} className=' mx-auto transition duration-[0.7s] ease in out' /></div> 
//               <div className=' lg:md:hidden inline w-[320px] h-[240px] mr-[60px] ml-[50px] rounded-[15px] absolute top-[250px] left-[-5%] '><ImageSlider images={images} interval={1500} alt="Payment Sample" width={520} height={440} className=' mx-auto transition duration-[0.7s] ease-in-out  ' /></div>
//             </div>
//             <Link href="/nextPage"><div className='hidden lg:md:inline w-[139px] h-[54px] rounded-[18px] absolute left-[610px] text-center bg-white pt-[16px] pr-[24px] pb-[16px] pl-[24px] mx-auto hover:scale-[1.2] transition duration-[0.7s] ease-in-out' >
...
//               </div>
//               <Link href="/nextPage"><div className='lg:md:hidden inline absolute left-[120px] top-[480px] w-[139px] h-[54px] rounded-[18px]  bg-white pt-[16px] pr-[24px] pb-[16px] pl-[24px] mx-auto hover:scale-[1.2] transition duration-[0.7s] ease-in-out' >
