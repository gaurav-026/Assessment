  ...
  return (
    <div className=' md:w-full w-[105%] md:h-[724px] h-[571px] absolute top-[740px]   p-[40px] bg-[#4A508E] -z-20  mr-[20px]'>
        <div className='md:w-[1264px] w-[370px]  md:h-[644px] h-[571px]  gap-[50px] flex flex-col  md:mx-auto md:ml-0 ml-[-41px]  '>
            ...
            <div className='hidden md:inline'> <ImageSlider images={images} interval={1500} alt="Payment Sample" width={720} height={405} className=' mx-auto transition duration-[0.7s] ease in out' /></div> 
              <div className=' md:hidden inline w-[320px] h-[240px] mr-[60px] ml-[50px] rounded-[15px] absolute top-[250px] left-[-5%] '><ImageSlider images={images} interval={1500} alt="Payment Sample" width={520} height={440} className=' mx-auto transition duration-[0.7s] ease-in-out  ' /></div>
            </div>
            ...
            <div className=' absolute top-[110px] left-[40px] w-[347px] h-[129px] pt-[0px] pl-[16px]  pr-[0px] pb-[16px] flex flex-col  mx-auto justify-between'> 
                 <div className='md:hidden inline w-[380px] h-[29px]  font-[Urbanist] font-[700] leading-[48px] text-[#F8F9FB]  text-3xl  tracking-[.07em] text-center absolute right-[10px] bottom-[190px] '>Your audience wants links</div>
              ...
              <Link href="/nextPage"><div className='md:hidden inline absolute left-[120px] top-[480px] w-[139px] h-[54px] rounded-[18px]  bg-white pt-[16px] pr-[24px] pb-[16px] pl-[24px] mx-auto hover:scale-[1.2] transition duration-[0.7s] ease-in-out' >
