...
function How() {
  return (
    <div className=' md:w-full w-[375px] md:h-[1975px] h-[1433px] bg-white flex  absolute md:top-[120px] top-[155px]  shadow-[rgba(236,233,233,0.1)] '>
        ...
        <div className='md:w-[630px] md:h-[1975px] w-[0px] h-[1198px]  flex gap-[50px] '>
          ...
          <div className='w-[520px] h-[1975px]   gap-[120px] flex flex-col '>
             <div className='md:w-[520px] md:h-[403px] w-[283px] h-[250.83px] gap-[24px]  flex flex-col   absolute md:left-[680px] md:top-[5px] left-[68px] top-[248px]'>
              <div className='md:w-[520px] md:h-[57px] w-[280px] h-[88px]  font-[Urbanist] font-[700] leading-[26.4px] text-[#11151D] md:text-xl text-[14px] tracking-wider   '>Share the holidays, stays and experiences with your friends and family</div>
              <div className='md:w-[520px] md:h-[34px] w-[283px] h-[32px] mt-[-9px] font-[Urbanist] font-[500] leading-[19.2px] text-[#404040] text-base tracking-wide'>You receive trending & curated Itineraries and Insider deals on Hotels & Flights to share</div>
             ...
             <div className='md:w-[520px] md:h-[403px] w-[283px] h-[256px]  gap-[24px]  flex flex-col   absolute md:left-[680px] md:top-[525px] left-[68px] top-[570px]'>
              <div className='md:w-[520px] md:h-[57px] w-[282px] h-[32px]  font-[Urbanist] font-[700] leading-[26.4px] text-[#11151D] md:text-xl text-[14px] tracking-wider   '>Understand their requirements and budgets</div>
              <div className='md:w-[520px] md:h-[34px] w-[283] h-[34] font-[Urbanist] font-[500] leading-[19.2px] text-[#404040] text-base tracking-wide'>You receive trending & curated Itineraries and Insider deals on Hotels & Flights to share</div>
              <Image src={work} alt='work' width={520} height={264} className=' shadow-[rgba(0,0,0,0.1)] hidden md:inline'/>
              <Image src={work} alt='work' width={226} height={133} className=' shadow-[rgba(0,0,0,0.1)] md:hidden inline '/>
             </div>
             <div className='md:w-[520px] md:h-[403px] w-[283px] h-[256px] gap-[24px]  flex flex-col  absolute md:left-[680px] md:top-[1050px] left-[68px] top-[885px]'>
              <div className='md:w-[520px] md:h-[57px] w-[282px] h-[32px] font-[Urbanist] font-[700] leading-[26.4px] text-[#11151D] md:text-xl text-[14px] tracking-wider   '>Share the payment link, sit back and relax</div>
              <div className='md:w-[520px] md:h-[34px] w-[283px] h-[34px] font-[Urbanist] font-[500] leading-[19.2px] text-[#404040] text-base tracking-wide '>You receive trending & curated Itineraries and Insider deals on Hotels & Flights to share</div>
              <Image src={work} alt='work' width={520} height={264} className=' shadow-[rgba(0,0,0,0.1)] hidden md:inline'/>
              <Image src={work} alt='work' width={226} height={133} className=' shadow-[rgba(0,0,0,0.1)] md:hidden inline mt-[15px]'/>
             </div>
             <div className='md:w-[520px] md:h-[403px] w-[283px] h-[242px] gap-[24px]  flex flex-col  absolute md:left-[680px] md:top-[1570px] left-[68px] top-[1185px]'>
              <div className='md:w-[520px] md:h-[57px] w-[282px] h-[18px] font-[Urbanist] font-[700] leading-[26.4px] text-[#11151D] md:text-xl text-[14px] tracking-wider   '>Get Rewarded each time</div>
              <div className='md:w-[520px] md:h-[34px] w-[283px] h-[34px] font-[Urbanist] font-[500] leading-[19.2px] text-[#404040] text-base tracking-wide'>You receive trending & curated Itineraries and Insider deals on Hotels & Flights to share</div>
              <Image src={work} alt='work' width={520} height={264} className=' shadow-[rgba(0,0,0,0.1)] hidden md:inline'/>
              <Image src={work} alt='work' width={226} height={133} className=' shadow-[rgba(0,0,0,0.1)] md:hidden inline mt-[15px]'/>
             </div>
